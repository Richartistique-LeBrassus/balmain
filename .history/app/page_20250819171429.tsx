...
import HomeSection from "@/components/HomeSection"; // renamed import
import ExploreAndViewMore from "@/components/ExploreAndViewMore";
...
export default async function HomePage() {
  ...
  console.log(
    ...
    `>>> Rendered the home page cache with ${products.length}
